...
# code2llm | 159f 23855L | python:103,md:18,json:11,txt:6,yaml:6,javascript:5,shell:3,yml:1,ini:1 | 2026-06-04
# generated in 0.05s
# CC̅=2.9 | critical:1/1045 | dups:0 | cycles:0
...
PIPELINES[495]:
  ...
  [19] Src [_run_schema_migrations]: _run_schema_migrations
      PURITY: 100% pure
  [20] Src [backend_url]: backend_url → backend_candidates
      PURITY: 100% pure
  [21] Src [health]: health → backend_candidates
      PURITY: 100% pure
  [22] Src [chat_start]: chat_start → _post_json → backend_candidates
      PURITY: 100% pure
  [23] Src [chat_message]: chat_message → _post_json → backend_candidates
      PURITY: 100% pure
  [24] Src [form_to_prompt]: form_to_prompt
      PURITY: 100% pure
  [25] Src [primary_action]: primary_action
      PURITY: 100% pure
  [26] Src [step_config]: step_config
      PURITY: 100% pure
  [27] Src [health]: health
      PURITY: 100% pure
  [28] Src [workspace_home]: workspace_home
      PURITY: 100% pure
  [29] Src [agent_workroom_page]: agent_workroom_page
      PURITY: 100% pure
  [30] Src [access_matrix_page]: access_matrix_page
      PURITY: 100% pure
  [31] Src [dashboard]: dashboard
      PURITY: 100% pure
  [32] Src [state]: state
      PURITY: 100% pure
  [33] Src [r]: r
      PURITY: 100% pure
  [34] Src [checked]: checked → escapeHtml
      PURITY: 100% pure
  [35] Src [load]: load → api
      PURITY: 100% pure
  [36] Src [diag]: diag
      PURITY: 100% pure
  [37] Src [save]: save → api
      PURITY: 100% pure
  [38] Src [res]: res → api
      PURITY: 100% pure
  [39] Src [resetAll]: resetAll → api
      PURITY: 100% pure
  [40] Src [title]: title → toast
      PURITY: 100% pure
...
LAYERS:
  ...
  │ policy_engine              124L  2C    8m  CC=7      ←0
  ...
  │ workspace_routes            77L  0C    5m  CC=2      ←0
  ...
  │ routing_policy.yaml         38L  0C    0m  CC=0.0    ←0
  ...
  │ CHANGELOG.md               305L  0C    0m  CC=0.0    ←0
  │ TODO.md                    239L  0C    0m  CC=0.0    ←0
  │ README.md                  213L  0C    0m  CC=0.0    ←0
  │ docker-compose.yml         204L  0C    0m  CC=0.0    ←0
  │ Makefile                    94L  0C    0m  CC=0.0    ←0
...
# redup/duplication | 27 groups | 110f 15613L | 2026-06-04
...
HOTSPOTS[7] (files with most duplication):
  services/projector/app/main.py  dup=217L  groups=2  frags=12  (1.4%)
  services/orchestrator/app/observability/export.py  dup=109L  groups=2  frags=5  (0.7%)
  services/orchestrator/app/api/commands.py  dup=105L  groups=1  frags=7  (0.7%)
  ...
  services/web/app/conductor.py  dup=34L  groups=1  frags=2  (0.2%)
...
DUPLICATES[27] (ranked by impact):
  ...
  [8182d5c2ea80ccd7] ! STRU  _fetch_incidents  L=31 N=3 saved=62 sim=1.00
      services/orchestrator/app/observability/export.py:164-194  (_fetch_incidents)
      services/orchestrator/app/observability/export.py:210-238  (_fetch_incident_feed)
      services/orchestrator/app/observability/export.py:254-280  (_fetch_rag_snapshots)
  ...
  [3fe0219ba048af7c]   STRU  _execute_file_list_route  L=17 N=2 saved=17 sim=1.00
      services/web/app/conductor.py:110-126  (_execute_file_list_route)
      services/web/app/conductor.py:215-231  (_execute_rag_route)
  ...
  [bf2a5890b439ae0d]   STRU  _safe_fetch_incident_feed  L=11 N=2 saved=11 sim=1.00
      services/orchestrator/app/observability/export.py:197-207  (_safe_fetch_incident_feed)
      services/orchestrator/app/observability/export.py:241-251  (_safe_fetch_rag_snapshots)
  ...
  [46f02a3f0dd7583d]   STRU  agent_may_access_resource  L=7 N=2 saved=7 sim=1.00
      services/web/app/access_matrix.py:211-217  (agent_may_access_resource)
      services/web/app/access_matrix.py:220-226  (human_may_use_agent)
  ...
  [9a129a96b21d1689]   EXAC  _checks_list_payload  L=6 N=2 saved=6 sim=1.00
      services/orchestrator/app/observability/incidents.py:497-502  (_checks_list_payload)
  ...
  [bd20ef24149cc1ac]   STRU  _incident_trace_part  L=6 N=2 saved=6 sim=1.00
      services/web/app/chat.py:508-513  (_incident_trace_part)
      services/web/app/chat.py:524-529  (_incident_fallback_part)
  ...
  [49d1d03e6ce392a1]   STRU  _default_chat_reply  L=5 N=2 saved=5 sim=1.00
      services/web/app/chat.py:777-781  (_default_chat_reply)
      services/web/app/prompt_router.py:362-369  (_llm_system_prompt)
...
REFACTOR[27] (ranked by priority):
  ...
  [6] ○ extract_function   → services/orchestrator/app/api/utils/transfer_resource.py
  ...
  [7] ○ extract_function   → services/web/app/utils/_execute_file_list_route.py
      WHY: 2 occurrences of 17-line block across 1 files — saves 17 lines
      FILES: services/web/app/conductor.py
  [8] ○ extract_function   → services/orchestrator/app/domain/events/utils/data.py
      WHY: 3 occurrences of 6-line block across 1 files — saves 12 lines
      FILES: services/orchestrator/app/domain/events/plugins.py
  [9] ○ extract_function   → services/orchestrator/app/api/utils/list_resources.py
      WHY: 2 occurrences of 11-line block across 2 files — saves 11 lines
      FILES: services/orchestrator/app/api/access.py, services/orchestrator/app/api/evolution.py
  [10] ○ extract_function   → services/orchestrator/app/observability/utils/_safe_fetch_incident_feed.py
      WHY: 2 occurrences of 11-line block across 1 files — saves 11 lines
      FILES: services/orchestrator/app/observability/export.py
  [11] ○ extract_function   → services/web/app/utils/_run_analyze_workroom_step.py
      WHY: 2 occurrences of 11-line block across 1 files — saves 11 lines
      FILES: services/web/app/agent_workroom.py
  [12] ○ extract_function   → services/projector/app/projections/utils/project_agent_fleet.py
  ...
  [13] ○ extract_function   → services/web/app/utils/_projector.py
      WHY: 2 occurrences of 7-line block across 2 files — saves 7 lines
      FILES: services/web/app/chat.py, services/web/app/workspace.py
  [14] ○ extract_function   → services/web/app/utils/agent_may_access_resource.py
      WHY: 2 occurrences of 7-line block across 1 files — saves 7 lines
      FILES: services/web/app/access_matrix.py
  [15] ○ extract_function   → services/web/app/utils/_run_analyze_step.py
      WHY: 2 occurrences of 7-line block across 1 files — saves 7 lines
      FILES: services/web/app/agent_workroom.py
  [16] ○ extract_function   → services/orchestrator/app/domain/events/utils/data.py
      WHY: 2 occurrences of 6-line block across 1 files — saves 6 lines
      FILES: services/orchestrator/app/domain/events/incidents.py
  [17] ○ extract_function   → services/utils/_checks_list_payload.py
  ...
  [19] ○ extract_function   → services/web/app/utils/_empty_agent_resource.py
      WHY: 2 occurrences of 6-line block across 1 files — saves 6 lines
      FILES: services/web/app/access_matrix.py
  [20] ○ extract_function   → services/web/app/utils/_incident_trace_part.py
      WHY: 2 occurrences of 6-line block across 1 files — saves 6 lines
      FILES: services/web/app/chat.py
  [21] ○ extract_function   → services/orchestrator/app/api/utils/probe_uri.py
      WHY: 2 occurrences of 5-line block across 1 files — saves 5 lines
      FILES: services/orchestrator/app/api/access.py
  [22] ○ extract_function   → services/utils/connect.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: services/orchestrator/app/infrastructure/postgres.py, services/projector/app/db.py
  [23] ○ extract_function   → services/utils/execute.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: services/orchestrator/app/infrastructure/postgres.py, services/projector/app/db.py
  [24] ○ extract_function   → services/utils/fetch.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: services/orchestrator/app/infrastructure/postgres.py, services/projector/app/db.py
  [25] ○ extract_function   → services/web/app/utils/_default_chat_reply.py
      WHY: 2 occurrences of 5-line block across 2 files — saves 5 lines
      FILES: services/web/app/chat.py, services/web/app/prompt_router.py
  [26] ○ extract_function   → services/utils/disconnect.py
      WHY: 2 occurrences of 4-line block across 2 files — saves 4 lines
      FILES: services/orchestrator/app/infrastructure/postgres.py, services/projector/app/db.py
  [27] ○ extract_function   → services/utils/__init__.py
...
QUICK_WINS[20] (low risk, high savings — do first):
  ...
  [5] extract_function   saved=40L  → services/orchestrator/app/api/utils/get_task.py
      FILES: queries.py
  [6] extract_function   saved=18L  → services/orchestrator/app/api/utils/transfer_resource.py
      FILES: access.py, evolution.py
  [7] extract_function   saved=17L  → services/web/app/utils/_execute_file_list_route.py
      FILES: conductor.py
  [8] extract_function   saved=12L  → services/orchestrator/app/domain/events/utils/data.py
      FILES: plugins.py
  [9] extract_function   saved=11L  → services/orchestrator/app/api/utils/list_resources.py
      FILES: access.py, evolution.py
  [10] extract_function   saved=11L  → services/orchestrator/app/observability/utils/_safe_fetch_incident_feed.py
      FILES: export.py

EFFORT_ESTIMATE (total ≈ 19.5h):
  ...
  easy   _safe_fetch_incident_feed           saved=11L  ~22min
  ... +17 more (~208min)

METRICS-TARGET:
  dup_groups:  27 → 0
  saved_lines: 553 lines recoverable
```

### Evolution / Churn (`project/evolution.toon.yaml`)

```toon markpact:analysis path=project/evolution.toon.yaml
# code2llm/evolution | 1045 func | 85f | 2026-06-04
# generated in 0.00s

NEXT[4] (ranked by impact):
  [1] !! SPLIT           services/web/app/static/workspace.js
      WHY: 1129L, 0 classes, max CC=14
      EFFORT: ~4h  IMPACT: 15806

  [2] !! SPLIT           services/web/app/workspace.py
      WHY: 1166L, 2 classes, max CC=7
      EFFORT: ~4h  IMPACT: 8162
...
RISKS[3]:
  ...
  ⚠ Splitting services/web/app/workspace.py may break 79 import paths
  ⚠ Splitting services/web/app/static/workspace.js may break 139 import paths
